...
<script setup>
	...
	const chat_views = ref([
	{
		...
		},
		{
			...
			name: "学习助手",
			type: "Study",
			head_img_url: "http://94.74.87.251:8080/profile/avatar/2023/10/20/blob_20231020164720A056.png",
			msgs: [],
			last_word: "你好呀",
			last_word_date: 1690702956056,
			unread_count: 0,
		...
		},
		{
			...
			name: "HITwhLinker",
			type: "hitwhlinker",
			head_img_url: "http://94.74.87.251:8080/profile/avatar/2023/10/20/blob_20231020164901A057.png",
			msgs: [],
			last_word: "你好呀",
			last_word_date: 1690702956056,
			unread_count: 0
